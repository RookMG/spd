...
- **셀 정보**, **폴리곤 정보** 페이지
<img src="./docs/Readme_img/color_cell_info.PNG" width="600"/>
...
<img src="./docs/Readme_img/origin_poly.PNG" width="600"/>
<img src="./docs/Readme_img/after_poly.PNG" width="600"/>
...
- 새 셀 추가 버튼 또는 아이콘 클릭
- 이름, 좌표, 크기, 횟수 입력
- 폴리곤 그리기 버튼으로 폴리곤 패턴 제작

<br>

②	기존 파일 편집 시

- 파일 열기 아이콘 또는 (파일->열기) 클릭
- polygon 클릭
- 그래픽 상 변경 또는 데이터 입력으로 편집
- 새로운 셀 추가 가능
